                 ...
                 <x-inputs.text id='title' name='title' label='Job Title' placeholder='Software Engineer' />
                    ...
                    <h2 class="text-2xl font-bold mb-6 text-center text-gray-500">
                        Company Info
						  ...
						  <x-inputs.text id='company_website' name='company_website' label='Company Website' type="url" placeholder='Company Website' />
                    
						  <x-inputs.text id='contact_phone' name='contact_phone' label='Contact Phone' placeholder='Enter Phone' />
						  
						  <x-inputs.text id='contact_email' name='contact_email' type="email" label='Contact Email' placeholder='Contact Email' />
